...
#create table Users(username TEXT, password TEXT, admin int);
#if administrative user, admin == 1, else if normal user, admin == 0

#create table Posts(author TEXT, title TEXT, body TEXT, comments BLOB, date text);
#comments are a list of integers, which are the _ids of the comments in chronological order

#CREATE TABLE Comments(author Text, body TEXT, post TEXT, date text);
